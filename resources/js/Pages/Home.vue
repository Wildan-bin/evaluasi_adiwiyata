    ...
    >
        ...
        <main class="container mx-auto px-4 pt-24 pb-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 text-center mb-12">
                ...
                <p class="text-gray-600 mb-8 text-lg max-w-[80%] mx-auto">
                    Program Penilaian dan Evaluasi Peringkat PBLHS (PPEPP)
                    adalah sistem evaluasi komprehensif untuk mengukur dan
                    meningkatkan kualitas penerapan program lingkungan hidup di
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <p class="text-gray-600">
                        Evaluasi menyeluruh program lingkungan sekolah Anda
                    </p>
                </div>
                ...
                >
                    ...
                    <p class="text-gray-600">
                        Lihat hasil evaluasi dan rekomendasi perbaikan
                    </p>
                </div>
                ...
                >
                    ...
                    <p class="text-gray-600">
                        Kelola program lingkungan berkelanjutan di sekolah
                    </p>
                </div>
            </div>
            <!-- Another Section -->
            <div class="bg-white rounded-lg shadow-lg p-8 text-center mb-12 mt-12">
                <p class="text-gray-800 font-bold my-8 text-2xl max-w-[70%] mx-auto">
                    Komitmen Lingkungan
                </p>
                <p class="text-gray-800 my-8 text-xl max-w-[70%] mx-auto">
                    Kami berkomitmen untuk mendukung sekolah-sekolah dalam mengembangkan program lingkungan hidup yang berkelanjutan. Melalui GreenEdu, sekolah dapat mengevaluasi dan meningkatkan kualitas program mereka secara sistematis.
                </p>
            </div>
        </main>
    </div>
