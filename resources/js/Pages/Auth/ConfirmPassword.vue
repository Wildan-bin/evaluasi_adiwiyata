...
import { Leaf, Lock, CheckCircle, Eye, EyeOff } from 'lucide-vue-next';
...
<template>
    <Head title="Konfirmasi Password - Adiwiyata" />
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-8 py-12">
                    ...
                    <p class="text-green-100 text-center text-sm mt-2">Area Aman - Konfirmasi Password</p>
                </div>
